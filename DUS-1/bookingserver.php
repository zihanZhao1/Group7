<?php
    ...
    if(isset($_POST['facility'])&&isset($_POST['date'])&&isset($_POST['stime'])&&isset($_POST['etime'])){
        ...
        if($insert){
            ...
            try {                    
                ...
                echo "<script>alert('$message');</script>", $mail->ErrorInfo; 
            }  
        }else{
            $message="The time range you choosed has been booked!";
