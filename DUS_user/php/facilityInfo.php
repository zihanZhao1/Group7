...
<div class="container-fluid">
    ...
    <div id="content" class="row-fluid">
        <div class="span2 pages">
            <ul>
                <li class='navcurrent'><h3><?php echo $fname;?></h3></li>
            </ul>
        </div>
        <div class="span10">

            <table class="table table-hover" border="3" style="width:60%; margin:auto"><img
                        src="../img/<?php echo $fname ?>.jpg" alt="Squash-Courts"
                        style="width:170px;height:170px;margin-left:15px;float: right;">
                <tbody>
                <tr>
