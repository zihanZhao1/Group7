              	 ...
              	 var title= "<table width='80%' border='1' cellpadding='0' cellspacing='0'><tr height='30px'><td></td><td>Facility ID</td><td>Facility Name</td><td>Block start time</td><td>Block end time</td><td>Availability</td></tr>";
					var dataObj = data,str = "";
						...
						str+="<tr height='30px'><td colspan='7'><input type='checkbox' id='qx' /> ALL <input class='btn btn-primary btn-sm' type='button' id='btn' value='Delete' /></td></tr>";
						 str+="<tr height='30px'><td colspan='7'>Facility ID:<input size=10 type='text' id ='F_ID' required='required' >Block start time:<input size=15 type='text' id='start' required='required'>Block end time:<input size=15 type='text' id='end' required='required'><input class='btn btn-primary btn-sm' type='button' id='addData' value='Add Block' /></td></tr>";
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="F_ID" id="F_ID" class="form-control" required="required"/>
                        </div>
                        <div class="form-group">
                            <label> Start Time</label>
                            <input type="datetime-local" name="start" id="start" class="form-control" required="required"/>
                        </div>

                        <div class="form-group">
                            <label> End Time</label>
                            <input type="datetime-local" name="end" id="end" class="form-control" required="required"/>
                        </div>
                        <div class="form-group">
                            <label> Count</label>
                            <input type="number" name="count" id="count" class="form-control" required="required"/>
                        </div>
                        <div class="form-group">
                            <label> Avb</label>
                            <input type="text" name="Avb" id="Avb" class="form-control" required="required"/>
                        </div>
                        <div class="form-group">
                            <label> UserID</label>
                            <input type="number" name="U_ID" id="U_ID" class="form-control" required="required"/>
                        </div>
