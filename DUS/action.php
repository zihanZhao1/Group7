<?php
    ...
    if(isset($_POST["action"])){
        if($_POST["action"] == "insert"){
            $query="insert into sei_course(name,F_ID,start_date,end_date,start_time,end_time,week) values('".$_POST["cn"]."','".$_POST["f"]."','".$_POST["sd"]."','".$_POST["ed"]."','".$_POST["st"]."','".$_POST["et"]."','".$_POST["wd"]."')";
